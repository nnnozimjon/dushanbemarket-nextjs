        ...
        <Container size={'xl'}>
            <div className='my-4 md:py-10 flex lg:flex-row flex-col gap-5'>
                <div className='w-full'>
                    ...
                    {wishlist?.products.length == 0 && <Flex direction={'column'} gap={'lg'} className='w-full h-[600px]' align={'center'} justify={'center'}>
                        <Icon variant='outline' name='heart' className='h-[120px] w-[120px] md:h-[180px] md:w-[180px] text-[#01B766]' />
