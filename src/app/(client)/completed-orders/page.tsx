            ...
            <div className='my-4 md:py-10 flex lg:flex-row flex-col gap-5'>
                <div className='w-full'>
                    <Flex gap={'md'} align={'center'} >
                        <h1 className='text-[18px] md:text-[2em]'>Cписок завершенных заказов</h1>
                        <Text className='p-0 m-0'>
                            ({activeOrdersList?.length} товар)
                        </Text>
                    </Flex>
                    {activeOrdersList?.length == 0 && <Flex direction={'column'} gap={'lg'} className='w-full h-[600px]' align={'center'} justify={'center'}>
                        <Icon name='shippingEconomy' className='h-[120px] w-[120px] md:h-[180px] md:w-[180px] text-[#01B766]' />
                    ...
                    {activeOrdersList?.length > 0 && <Flex gap={'lg'} wrap={'wrap'} align={'center'} justify={'start'} >
